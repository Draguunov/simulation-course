...
Графический интерфейс содержит две вкладки: «Дискретные величины» и «Нормальное распределение».
...
#### 5.1. Дискретная СВ (равномерное распределение на 4 значениях, $p_i=0.2$)
